        ...
        <template v-else>
            ...
            <div class="grid gap-4 lg:grid-cols-[360px_minmax(0,1fr)]">
                        ...
                        >
                            <div class="flex min-w-0 items-center gap-3">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p
                                        class="mt-0.5 text-sm capitalize text-gray-500"
                                    >
                        ...
                        <div class="rounded-xl border border-gray-200 bg-white p-5">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p
                                        class="mt-1 truncate text-sm font-semibold uppercase text-gray-900"
                                    >
                ...
                <aside class="order-1 lg:sticky lg:top-6 lg:self-start">
                    ...
                    >
                        <div class="bg-gray-900 px-5 py-5 text-white">
                            <div class="flex items-center justify-between gap-3">
                                ...
                                <StatusBadge :status="visitor.status?.toLowerCase().replace(/\s+/g, '_')" />
                            </div>
                            <p class="mt-3 text-sm text-gray-300">
                                {{ visitor.status === 'Active' ? 'Present this pass at the guard house.' : 'This QR code is for reference only.' }}
                            </p>
                        </div>
                    ...
                    <div
                        v-else-if="qrError"
                        class="flex items-start gap-3 rounded-xl bg-yellow-50 border border-yellow-100 px-5 py-4"
                    >
                        <svg
                    ...
                    >
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            No QR code is available for this visitor pass.
                        </p>
                    </div>
                </aside>
            </div>
